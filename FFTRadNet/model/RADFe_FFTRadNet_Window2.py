...
class RADFE(nn.Module):
    def __init__(self, 
                 fast_time_len=512, fast_time_downsampling_len = 32, fast_time_layers=1, fast_time_linear_dims=[192*2],  
        ...
        self.fast_down = nn.Sequential(
            ...
            nn.SiLU(),
            nn.Conv1d(self.fast_time_len//2, fast_time_downsampling_len, kernel_size=1),
        )
        self.fast_norm_compress = nn.LayerNorm(fast_time_downsampling_len)
